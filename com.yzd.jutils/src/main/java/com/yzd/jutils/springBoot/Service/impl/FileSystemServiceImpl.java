package com.yzd.jutils.springBoot.Service.impl;
...
import com.yzd.jutils.springBoot.Service.FileSystemService;
import com.yzd.jutils.springBoot.application.SftpProperties;
...
public class FileSystemServiceImpl implements FileSystemService {
	...
	private ChannelSftp connectByKey() throws Exception {
		...
		log.info("Try to connect sftp[" + config.getUsername() + "@" + config.getHost() + "], use private key["
				+ config.getPrivateKey() + "] with passphrase[" + config.getPassphrase() + "]");
