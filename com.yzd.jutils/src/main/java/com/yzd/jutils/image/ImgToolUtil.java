...
public class ImgToolUtil {
	...
	protected AffineTransformOp getTransformOp(boolean isHorizontal) {
		...
		// new AffineTransform(-1, 0, 0, -1, image.getWidth(),
		// image.getHeight());// 旋转180度
	...
	public ImgToolUtil draw(String imgPath, Align align, Double degree, int offsetX, int offsetY, float alpha)
			throws IOException {
